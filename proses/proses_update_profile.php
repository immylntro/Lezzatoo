<?php
	...
	if ($password1 == $password2) {
		if (!empty($password1) && !empty($password2)) {
			...
			$query = mysqli_query($koneksi,$sql);
			echo "<script>alert('Update berhasil tanpa merubah password');location.href='../admin/home.php';</script>";
		}
	} else {
		echo "<script>alert('Update gagal! Password tidak sama');location.href='../admin/home.php';</script>";
	}
